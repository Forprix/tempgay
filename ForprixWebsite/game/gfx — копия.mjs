...
export class Matrix2D {
    ...
    */
    ...
    /**
     * offsetX and offsetY are global rather than relative to current transformation
    ...
    */
    ...
    /**
     * centerX and centerY are global rather than relative to current transformation 
    ...
    */
    rotate(degrees = 0, centerX = 0, centerY = 0) {
        ...
        [v[0], v[1], v[3], v[4], v[6], v[7]] = [
            cosVal * v[0] + -sinVal * v[1],
            sinVal * v[0] + cosVal * v[1],
            cosVal * v[3] + -sinVal * v[4],
            sinVal * v[3] + cosVal * v[4],
            cosVal * v[6] + -sinVal * v[7] + (-cosVal * centerX + sinVal * centerY + centerX),
            sinVal* v[6]  + cosVal * v[7]  + (-sinVal * centerX - cosVal * centerY + centerY),
        ]
        return this
    }
    /**
    ...
    */
    scale(scaleX = 1, scaleY = 1, centerX = 0, centerY = 0) {
        ...
        // v[0] *= scaleX
        // v[4] *= scaleY
        // v[6] += (centerX - v[6]) * (1 - scaleX)
        // v[7] += (centerY - v[7]) * (1 - scaleY)

        this.v = Matrix2D.multiply(this, new Matrix2D(scaleX, 0, 0, scaleY, 0, 0)).v
