...
var userAgentRules = [
    ['AOL Explorer', /AOLShield\/([0-9\._]+)/],
    ['Microsoft Edge', /Edge\/([0-9\._]+)/],
    ['Microsoft Edge', /EdgiOS\/([0-9\._]+)/],
    ['Yandex Browser', /YaBrowser\/([0-9\._]+)/],
    ['Samsung Browser', /SamsungBrowser\/([0-9\.]+)/],
    ['Amazon Silk', /\bSilk\/([0-9._-]+)\b/],
    ['Miui Browser', /MiuiBrowser\/([0-9\.]+)$/],
    ['Beaker Browser', /BeakerBrowser\/([0-9\.]+)/],
    ['Microsoft Edge', /EdgA?\/([0-9\.]+)/],
    ...
    ['Android Browser', /Android\s([0-9\.]+)/],
    ['Safari Mobile', /Version\/([0-9\._]+).*Mobile.*Safari.*/],
